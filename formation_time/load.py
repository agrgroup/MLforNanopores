...
def newFeat(data):
    ...
    ZZ_features = data['mirror_30_clock_vertical'] + data['mirror_90_clock_vertical'] + data['mirror_150_clock_vertical']
    AC_features = data['mirror_vertical'] + data['mirror_60_clock_vertical'] + data['mirror_120_clock_vertical']

    data['ZZ_features'] = ZZ_features
    data['AC_features'] = AC_features
    ...
    data = data.drop(columns=['unique_id', 'probability'])
